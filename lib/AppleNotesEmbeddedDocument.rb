##
# This class represents a document-ish object embedded
# in an AppleNote. This means you shared something like an Office document from another application.
class AppleNotesEmbeddedDocument < AppleNotesEmbeddedObject
